      ...
      positions: [
        {
          ...
          descriptions: [
            ...
            '단위 테스트 도입으로 테스트 커버리지 60%를 확보하여 리팩토링 안정성을 향상',
            'ESLint Custom Rule 및 Husky hook을 적용하여 코드 일관성을 확보함으로써 코드 리뷰 시간 단축 및 잠재적 오류 예방',
            '프로젝트 마무리 회고 밋업과 기능 검증을 위한 1,2차 QA 시스템을 제안하여 팀 협업 효율 증대에 기여',
          ],
          skillKeywords: [
            'Vue.js',
            'Typescript',
      ...
      positions: [
        {
          ...
          descriptions: [
            ...
            'React 기반 신규 가입 기능 개발을 담당했으며, 회고 문화를 제안',
      ...
      positions: [
        {
          ...
          descriptions: [
            ...
            'Storybook 기반 UI 시스템을 제안하고 구축하여, 디자인팀과 개발팀 간의 불일치를 줄이고 컴포넌트 재사용성 증대',
